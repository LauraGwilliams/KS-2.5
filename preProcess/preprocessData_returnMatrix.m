function [all_data] = preprocessData_returnMatrix(ops)
% this script is a copy of preprocessDataSub - it returns the data matrix
% rather than saving directly to the temp_wh.dat
