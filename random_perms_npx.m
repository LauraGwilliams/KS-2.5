...
out_fname = '/userdata/lgwilliams/neuropixels/data/NP04/out_structs/117_sua_preproc_out_1000.mat';
...
%     end
    ...
    % save it
    save_mel_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_mel-1000.mat');
    save_sua_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_sua117-1000.mat');
    save_fea_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_fea-1000.mat');
    save_phn_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_phn-1000.mat');
    save_formant_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_formant-1000.mat');
    save_formant_normed_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_formant_normed-1000.mat');
    save_probs_fname = strcat('/userdata/lgwilliams/neuropixels/data/NP04/out_structs/random_perms/p', int2str(random_i), '_probs-1000.mat');
